class AppAssets {
  ...
  static const String banner2Image = "$imagePath/banner-2-image.png";
  static const String banner3Image = "$imagePath/banner-3-image.png";
  static const String basketIcon = "$iconPath/basket-icon.png";
  static const String bellIcon = "$iconPath/bell-icon.png";
  static const String walletIcon = "$iconPath/wallet-icon.png";
  static const String scanIcon = "$iconPath/scan-icon.png";
  static const String historyIcon = "$iconPath/history-icon.png";
  static const String starIcon = "$iconPath/star-icon.png";
  static const String medalSilverIcon = "$iconPath/medal-silver-icon.png";
  static const String medalGoldIcon = "$iconPath/medal-gold-icon.png";
  static const String crownIcon = "$iconPath/crown-icon.png";
  static const String speakerIcon = "$iconPath/speaker-icon.png";
